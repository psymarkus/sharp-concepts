...
citation_apa = escape(
    ...
    "Stadler, M., Holzberger, D., & Fischer, F. (2026). "
    "SHARP Concepts Ontology (Version 0.1.0) [Computer software]. "
    "https://w3id.org/sharp/ontology"
)
citation_bibtex = """@software{SHARP_Consortium_SHARP_Concepts_Ontology_2026,
